...
package org.wso2.carbon.identity.utility.hash.generator.bcrypt;

import org.apache.commons.logging.Log;
import org.apache.commons.logging.LogFactory;
import org.wso2.carbon.identity.hash.provider.bcrypt.BCRYPTHashProvider;
...
/**
 * This class contains the client for generate BCRYPT hash and the salt value for a given plain text password.
 */
public class BCRYPTHashGenerator {

    private static final Log log = LogFactory.getLog(BCRYPTHashGenerator.class);
    private static final String SHA_1_PRNG = "SHA1PRNG";
    private static BCRYPTHashProvider bcryptHashProvider;
    ...
    /**
     * This method used to initialize the BCRYPT hash provider instance.
     */
    ...
    private static byte[] calculateHash(char[] plainText, String salt) throws HashProviderException {
        ...
        return bcryptHashProvider.calculateHash(plainText, salt);
    }
